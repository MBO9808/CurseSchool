...
import com.example.curseschool.Adapters.GradeCourseTeacherAdapter;
...
public class GradeCourseTeacherView extends AppCompatActivity {

    RecyclerView recyclerView;

    private GradeCourseTeacherAdapter gradeCourseTeacherAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_grade_course_teacher_view);
        toolbar = findViewById(R.id.mainToolBar);
        setSupportActionBar(toolbar);
        toolbar.setNavigationIcon(R.drawable.ic_arrow_back);
        toolbar.setTitle("Lista prowadzonych kursów");
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(GradeCourseTeacherView.this, MainSite.class));
            }
        });
        initDictionaryView();
        handleCoursesList();
    ...
    private void initDictionaryView() {
        recyclerView = findViewById(R.id.gradeTeacherView);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        courseArrayList = new ArrayList<>();
        gradeCourseTeacherAdapter = new GradeCourseTeacherAdapter(this, courseArrayList, GradeCourseTeacherView.this);
        recyclerView.setAdapter(gradeCourseTeacherAdapter);
